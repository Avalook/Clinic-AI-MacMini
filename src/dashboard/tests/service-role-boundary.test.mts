...
const ALLOWED = new Map<string, string>([
  ...
  ["app/api/clinical-record/route.ts", "W5: the clinical write path -> a new clinical router"],
  ["app/api/clinical-form/route.ts", "W5: -> clinical router"],
  ["app/api/ultrasound/route.ts", "W5: ultrasound_record is backend-only -> clinical router"],
  ["app/api/lab-result/route.ts", "W5: -> lab router (POST /api/v1/triage already exists)"],
