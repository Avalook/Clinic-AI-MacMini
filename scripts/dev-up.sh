...
# The first screen is /login — one account per person. There used to be a
# shared clinic password in front of it (CLINIC_SHARED_EMAIL); it is gone, so
# there is no env var here whose absence locks the front door.
